                    ...
                    <ul class="dropdown-menu">
                        <li{{{ (Request::is('account/profile') ? ' class="active"' : '') }}}>
                         	<a href="{{ route('view-assets') }}">
                                <i class="fa fa-check fa-fw"></i> Lihat aset yang diimiliki
                        	</a>
                             <a href="{{ route('profile') }}">
                                <i class="fa fa-user fa-fw"></i> Edit Profil)
                            </a>
                             <a href="{{ route('change-password') }}">
                                <i class="fa fa-lock fa-fw"></i> Ganti Password)
                            </a>
                            <a href="{{ route('change-email') }}">
                                <i class="fa fa-envelope fa-fw"></i> Ubah Alamat Email
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
			...
			<li{{ (Request::is('*/') ? ' class="active"><div class="pointer"><div class="arrow"></div><div class="arrow_border"></div></div>' : '>') }}
                <a href="{{Config::get('app.url')}}"><i class="fa fa-dashboard"></i><span>Beranda</span></a>
            </li>
